        ...
        livros.forEach((livro) => {
            cardsDiv.innerHTML += `
                <div class="card">
                    ...
                    <p class="id">ID: ${livro.id}</p>
                    
                    <button class="btn-edit" onclick="editar(${livro.id})" disabled>Editar</button>
                    <button class="btn-delete" onclick="excluir(${livro.id})" disabled>Excluir</button>
                </div>
            `;
        });
    } catch (error) {
